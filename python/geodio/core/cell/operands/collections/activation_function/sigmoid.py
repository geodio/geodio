...
from geodio.core.cell.operands.collections.activation_function.base_activation_function import ActivationFunction
...
class SigmoidActivation(ActivationFunction):
    ...
    def get_operand_type(self):
        return geodio.geodio_bindings.OperandType.Sigmoid