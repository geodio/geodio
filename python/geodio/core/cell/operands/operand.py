...
from geodio import core
from geodio.core.cell.math.derivable import Derivable, WeightDerivable
from geodio.core.cell.math.hashy import Hashable, HashTree, HashNode
...
class Operand(Derivable, WeightDerivable, Hashable, metaclass=ABCMeta):
    ...
    def link(self, other: "Operand") -> "core.cell.Linker":
        ...
        Example:
            >>> from geodio.core import const, var
            >>> a = const(4)
