...
from geodio.core.cell.operands.constant import ONE, ZERO, Constant
from geodio.core.cell.operands.operand import Operand
from geodio.core.cell.math.hashy import HashLeaf
...
class BaseVariable(Operand, metaclass=ABCMeta):
    ...
    def get_operand_type(self):
        return geodio.geodio_bindings.OperandType.Variable
